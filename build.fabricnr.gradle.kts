...
// template at accesswidener/ (repo root) — same widening set as META-INF/accesstransformer_mojmap.cfg,
...
dependencies {
	...
	// implementation: on 26.x the jar is already named, and loom-no-remap has no remapping
	// configurations.
