...
import com.github.alexmodguy.alexscaves.citadel.server.world.ExpandedBiomeSource;
...
// Nothing in this tree ever constructs or posts this event — it survives only as the parameter type
// the BiomeGenerationConfig predicates are written against — so it needs no bus, just the EventBus 7
// supertype on Forge 56. See CitadelEvent.
@Deprecated(since = "2.6.0")
//? if forge && >=1.21.6
/*public class EventReplaceBiome extends net.minecraftforge.eventbus.api.event.MutableEvent {*/
//? if !forge || <1.21.6
