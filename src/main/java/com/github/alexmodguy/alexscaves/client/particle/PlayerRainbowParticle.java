...
public class PlayerRainbowParticle extends RainbowParticle {
    ...
    public Vec3 calculatePlayerPos(float partialTicks) {
        ...
        // Particle#getPos() is a Forge addition and its whole body is `new Vec3(x, y, z)` — the three
        // fields are protected in vanilla, so a subclass can simply say it itself.
        //? if fabric {
