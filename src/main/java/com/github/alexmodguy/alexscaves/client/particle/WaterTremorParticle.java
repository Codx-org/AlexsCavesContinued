...
public class WaterTremorParticle extends SimpleAnimatedParticle {
    ...
    private static final net.minecraft.client.particle.SingleQuadParticle.FacingCameraMode AC_FLAT =
            (quaternionf, camera, partialTick) -> quaternionf.set(com.mojang.math.Axis.XP.rotationDegrees(90.0F));
    *///?} else {
