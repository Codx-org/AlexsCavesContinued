...
public class MushroomCloudParticle extends ACCustomParticle {
    ...
    public void tick() {
        ...
        if (age < BALL_FOR) {
            ...
            for (int i = 0; i < (1 + random.nextInt(2)) * scale; i++) {
                Vec3 from = new Vec3(level.getRandom().nextFloat() - 0.5F, level.getRandom().nextFloat() - 0.5F, level.getRandom().nextFloat() - 0.5F).scale(scale * 1.4F).add(this.x, this.y, this.z);
                Vec3 away = new Vec3(level.getRandom().nextFloat() - 0.5F, level.getRandom().nextFloat() - 0.5F, level.getRandom().nextFloat() - 0.5F).scale(2.34F);
            ...
            for (int j = 0; j < scale * scale; j++) {
                Vec3 explosionBase = new Vec3((level.getRandom().nextFloat() - 0.5F) * explosionSpread, (-0.6F + level.getRandom().nextFloat() * 0.5F) * explosionSpread * 0.1F, (level.getRandom().nextFloat() - 0.5F) * explosionSpread).add(this.x, this.y, this.z);
