...
public class NucleeperEnergySwirlLayer  extends EnergySwirlLayer<NucleeperEntity, NucleeperModel> {
    ...
    public NucleeperEnergySwirlLayer(
            //? if >=1.21.2 {
            /*RenderLayerParent<com.github.alexmodguy.alexscaves.client.render.compat.ACRenderState, NucleeperModel> renderer
            *///?} else {
            RenderLayerParent<NucleeperEntity, NucleeperModel> renderer
            //?}
    ) {
        super(renderer);
    }
