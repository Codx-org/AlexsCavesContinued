...
public class SmallExplosionParticle extends ACQuadParticle {
    ...
    protected SmallExplosionParticle(ClientLevel world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, SpriteSet sprites, boolean shortLifespan, int color1) {
        ...
        this.quadSize = (shortLifespan ? 1 : 0.8F) + world.getRandom().nextFloat() * 0.3F;
        this.lifetime = shortLifespan ? 5 + world.getRandom().nextInt(3) : 15 + world.getRandom().nextInt(10);
        this.friction = 0.96F;
        float randCol = world.getRandom().nextFloat() * 0.05F;
        this.sprites = sprites;
        this.setColor(Math.min(ACColors.red(color1) / 255F + randCol, 1), Math.min(1F, ACColors.green(color1) / 255F + randCol), Math.min(1F, ACColors.blue(color1) / 255F + randCol));
    }
    ...
    public static class RaygunFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ...
            particle.setSpriteFromAge(spriteSet);
            particle.lifetime = 5 + worldIn.getRandom().nextInt(3);
            particle.scale(0.6F + worldIn.getRandom().nextFloat() * 0.3F);
    ...
    public static class BlueRaygunFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            SmallExplosionParticle particle = new SmallExplosionParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet, true, 0XEEEEEE);
            particle.setSpriteFromAge(spriteSet);
            particle.lifetime = 5 + worldIn.getRandom().nextInt(5);
            particle.scale(0.5F + worldIn.getRandom().nextFloat() * 0.5F);
    ...
    public static class TremorzillaFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            SmallExplosionParticle particle = new SmallExplosionParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet, true, 0XEEEEEE);
            particle.setSpriteFromAge(spriteSet);
            particle.lifetime = 9 + worldIn.getRandom().nextInt(3);
    ...
    public static class TotemFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ...
            particle.setSpriteFromAge(spriteSet);
            particle.lifetime = 5 + worldIn.getRandom().nextInt(3);
            particle.scale(1.2F + worldIn.getRandom().nextFloat() * 0.3F);
    ...
    public static class ConversionCrucibleFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            SmallExplosionParticle particle = new SmallExplosionParticle(worldIn, x, y, z, 0.0D, 0.0D, 0.0D, spriteSet, true, ACColors.argb(255, (int)(255F * xSpeed), (int)(255F * ySpeed), (int)(255F * zSpeed)));
            particle.setSpriteFromAge(spriteSet);
            particle.scale(0.8F);
            particle.setFadeColor(0XFFFFFF);
            return particle;
