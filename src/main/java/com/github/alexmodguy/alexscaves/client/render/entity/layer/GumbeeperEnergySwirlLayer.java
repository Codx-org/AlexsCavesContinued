...
public class GumbeeperEnergySwirlLayer extends EnergySwirlLayer<GumbeeperEntity, GumbeeperModel> {
    ...
    public GumbeeperEnergySwirlLayer(
            //? if >=1.21.2 {
            /*RenderLayerParent<com.github.alexmodguy.alexscaves.client.render.compat.ACRenderState, GumbeeperModel> renderer
            *///?} else {
            RenderLayerParent<GumbeeperEntity, GumbeeperModel> renderer
            //?}
    ) {
        super(renderer);
    }
