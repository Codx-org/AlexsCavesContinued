...
public class FerrouslimeParticle extends ACQuadParticle {
    ...
    protected FerrouslimeParticle(ClientLevel world, double x, double y, double z, double followEntityId, SpriteSet spriteSet) {
        ...
        this.quadSize *= 1.2F + world.getRandom().nextFloat() * 0.5F;
        this.hasPhysics = true;
        this.followEntityId = (int) followEntityId;
        this.pickSprite(spriteSet);
        this.lifetime = (int) (Math.random() * 30.0D) + 40;
        this.rCol = 0.22F - (world.getRandom().nextFloat() * 0.05F);
        this.gCol = 0.23F - (world.getRandom().nextFloat() * 0.05F);
        this.bCol = 0.32F - (world.getRandom().nextFloat() * 0.05F);
        this.friction = 0.8F;
        this.alpha = 0.5F + world.getRandom().nextFloat() * 0.3F;
    }
