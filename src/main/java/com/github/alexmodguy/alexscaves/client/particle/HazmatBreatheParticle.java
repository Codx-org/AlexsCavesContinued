...
public class HazmatBreatheParticle extends ACQuadParticle {
    ...
    protected HazmatBreatheParticle(ClientLevel level, double x, double y, double z, double xMotion, double yMotion, double zMotion, SpriteSet sprites, boolean blue) {
        ...
        float initialColor = level.getRandom().nextFloat() * 0.25F;
        float greenAmount = level.getRandom().nextFloat() * 0.5F + 0.5F;
