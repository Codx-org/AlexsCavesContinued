...
public class HullbreakerPartEntity extends PartEntity<HullbreakerEntity> implements CullingBoundsEntity {
    ...
    public boolean hurt(DamageSource source, float amount) {
        ...
        // See ACMultipartEntity#hurt for why 1.21.2 drops the client round-trip and spells the
        // invulnerability check isInvulnerableToBase.
        //? if >=1.21.2 {
