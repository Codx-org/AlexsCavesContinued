...
public class NotorEntity extends PathfinderMob {
    ...
    private static final EntityDataAccessor<Optional<UUID>> HOLOGRAM_ENTITY_UUID = SynchedEntityData.defineId(NotorEntity.class, ACEntityDataRegistry.OPTIONAL_UUID.get());
    ...
    public static final Predicate<LivingEntity> SCAN_TARGET = (mob) -> {
        return mob.isAlive() && !mob.getType().builtInRegistryHolder().is(ACTagRegistry.NOTOR_IGNORES) && !mob.isInvisible();
    };
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(HOLOGRAM_POS, Optional.empty());
    ...
    public void addAdditionalSaveData(CompoundTag compound) {
        ...
        if (this.getHologramUUID() != null) {
            ACCompat.putUUID(compound, "HologramUUID", this.getHologramUUID());
        }
    ...
    public void readAdditionalSaveData(CompoundTag compound) {
        ...
        this.setShowingHologram(ACCompat.getBoolean(compound, "ShowingHologram"));
        if (ACCompat.hasUUID(compound, "HologramUUID")) {
            this.setHologramUUID(ACCompat.getUUID(compound, "HologramUUID"));
        }
        stopScanningFor = ACCompat.getInt(compound, "StopScanningTime");
    }
