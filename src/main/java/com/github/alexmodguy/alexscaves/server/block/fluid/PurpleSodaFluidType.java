...
public class PurpleSodaFluidType extends FluidType implements ACClientExtensionFluidType {
    ...
    public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
        consumer.accept(new IClientFluidTypeExtensions() {
            // See AcidFluidType for why these two are gated and the overlay is not.
            //? if !neoforge || <26 {
            @Override
    ...
    public boolean isVaporizedOnPlacement(Level level, BlockPos pos, FluidStack stack) {
        // See AcidFluidType: ultraWarm became the WATER_EVAPORATES environment attribute in 1.21.11.
        //? if >=1.21.11 {
    ...
    // See AcidFluidType: the vaporising entity is a LivingEntity from 1.21.5, and only playSound
    // still needs it narrowed back to a Player.
    @Override
    //? if >=1.21.5
