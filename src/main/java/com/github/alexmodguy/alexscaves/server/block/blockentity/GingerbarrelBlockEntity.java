...
public class GingerbarrelBlockEntity extends RandomizableContainerBlockEntity {
    ...
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        protected void onOpen(Level p_155062_, BlockPos p_155063_, BlockState p_155064_) {
            ...
            GingerbarrelBlockEntity.this.updateBlockState(p_155064_, true);
        }

        protected void onClose(Level p_155072_, BlockPos p_155073_, BlockState p_155074_) {
            GingerbarrelBlockEntity.this.playSound(p_155074_, ACSoundRegistry.METAL_BARREL_LID.get());
            GingerbarrelBlockEntity.this.updateBlockState(p_155074_, false);
        }
    ...
    public GingerbarrelBlockEntity(BlockPos p_155052_, BlockState p_155053_) {
    ...
    protected AbstractContainerMenu createMenu(int p_58598_, Inventory p_58599_) {
        return new ChestMenu(MenuType.GENERIC_9x1, p_58598_, p_58599_, this, 1);
    }
    ...
    private void playSound(BlockState p_58601_, SoundEvent p_58602_) {
        ...
        this.level.playSound((Player) null, d0, d1, d2, p_58602_, SoundSource.BLOCKS, 0.5F, this.level.getRandom().nextFloat() * 0.1F + 0.9F);
    }
}