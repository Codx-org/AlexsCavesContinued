...
public class VolcanoStructurePiece extends StructurePiece {
    ...
    public VolcanoStructurePiece(CompoundTag tag) {
        ...
        this.center = new BlockPos(ACCompat.getInt(tag, "CPX"), ACCompat.getInt(tag, "CPY"), ACCompat.getInt(tag, "CPZ"));
        this.chunkCorner = new BlockPos(ACCompat.getInt(tag, "TPX"), ACCompat.getInt(tag, "TPY"), ACCompat.getInt(tag, "TPZ"));
        this.volcanoRadius = ACCompat.getInt(tag, "Radius");
        this.volcanoHeight = ACCompat.getInt(tag, "Height");
    }
    ...
    private static BoundingBox createBoundingBox(BlockPos chunkCorner) {
        ChunkPos chunkPos = ACCompat.chunkPos(chunkCorner);
