...
public class SubterranodonEntity extends DinosaurEntity implements PackAnimal, FlyingAnimal, KeybindUsingMount, FlyingMount, CullingBoundsEntity, ACRiderSitEntity {
    ...
    public void readAdditionalSaveData(CompoundTag compound) {
        ...
        this.setFlying(ACCompat.getBoolean(compound, "Flying"));
        this.timeFlying = ACCompat.getInt(compound, "TimeFlying");
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return ACCompat.temptable(Monster.createMonsterAttributes().add(Attributes.ATTACK_DAMAGE, 2.0D).add(Attributes.FLYING_SPEED, 1F).add(Attributes.MOVEMENT_SPEED, 0.2D).add(Attributes.FOLLOW_RANGE, 32.0D).add(Attributes.MAX_HEALTH, 20.0D));
    }
    ...
    *///?} else {
    ...
    public boolean isRiderInWall() {
        ...
        if (rider == null || rider.noPhysics) {
            ...
            float f = ACCompat.width(rider.getDimensions(Pose.STANDING)) * 0.8F;
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob mob) {
        return ACCompat.createEntity(ACEntityRegistry.SUBTERRANODON.get(), serverLevel);
    }
