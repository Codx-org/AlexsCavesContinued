...
public class ACTagRegistry {
    ...
    public static final TagKey<Block> TRENCH_GENERATION_REPLACEABLES = registerBlockTag("trench_generation_replaceables");
    ...
    // "Which items can carry this enchantment". Up to 1.20.4 that was an EnchantmentCategory — a
    // Predicate<Item> built in code — and Alex's Caves declares fourteen of them, each matching
    // exactly one item. 1.20.5 replaced the whole concept with a TagKey<Item> on the enchantment's
    // definition, so those predicates have to become real tags. Declared unconditionally and shipped
    // on every node: below 1.20.5 nothing reads them, which is cheaper than gating both the fields
    // and the fourteen JSON files. See ACEnchantmentRegistry.
    public static final TagKey<Item> ENCHANTABLE_GALENA_GAUNTLET = registerItemTag("enchantable/galena_gauntlet");
    public static final TagKey<Item> ENCHANTABLE_RESISTOR_SHIELD = registerItemTag("enchantable/resistor_shield");
    public static final TagKey<Item> ENCHANTABLE_PRIMITIVE_CLUB = registerItemTag("enchantable/primitive_club");
    public static final TagKey<Item> ENCHANTABLE_EXTINCTION_SPEAR = registerItemTag("enchantable/extinction_spear");
    public static final TagKey<Item> ENCHANTABLE_RAYGUN = registerItemTag("enchantable/raygun");
    public static final TagKey<Item> ENCHANTABLE_ORTHOLANCE = registerItemTag("enchantable/ortholance");
    public static final TagKey<Item> ENCHANTABLE_MAGIC_CONCH = registerItemTag("enchantable/magic_conch");
    public static final TagKey<Item> ENCHANTABLE_SEA_STAFF = registerItemTag("enchantable/sea_staff");
    public static final TagKey<Item> ENCHANTABLE_TOTEM_OF_POSSESSION = registerItemTag("enchantable/totem_of_possession");
    public static final TagKey<Item> ENCHANTABLE_DESOLATE_DAGGER = registerItemTag("enchantable/desolate_dagger");
    public static final TagKey<Item> ENCHANTABLE_DREADBOW = registerItemTag("enchantable/dreadbow");
    public static final TagKey<Item> ENCHANTABLE_SHOT_GUM = registerItemTag("enchantable/shot_gum");
    public static final TagKey<Item> ENCHANTABLE_CANDY_CANE_HOOK = registerItemTag("enchantable/candy_cane_hook");
    public static final TagKey<Item> ENCHANTABLE_SUGAR_STAFF = registerItemTag("enchantable/sugar_staff");
    ...
    // The two fluids this mod adds, each naming its source and its flowing form. Vanilla's per-entity
    // fluid bookkeeping is keyed on a TagKey<Fluid>, so these are what {@link ACFluids} asks an entity
    // about and what mixin.EntityMixin adds to the tracked set. See ACFluids for the whole story.
    public static final TagKey<Fluid> ACID = registerFluidTag("acid");
    public static final TagKey<Fluid> PURPLE_SODA = registerFluidTag("purple_soda");
