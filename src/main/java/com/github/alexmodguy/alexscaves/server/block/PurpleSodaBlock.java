...
public class PurpleSodaBlock extends LiquidBlock {
    ...
    /*public PurpleSodaBlock(Supplier<FlowingFluid> flowingFluid, BlockBehaviour.Properties properties) {
    ...
    *///?} else {
    ...
    public void entityInside(BlockState blockState, Level level, BlockPos pos, Entity entity) {
        ...
        if (entity instanceof LivingEntity && entity.moveDist > entity.nextStep && !(entity instanceof SweetishFishEntity)) {
            ...
            entity.playSound(ACSoundRegistry.PURPLE_SODA_SWIM.get(), f1, 1.0F + (level.getRandom().nextFloat() - level.getRandom().nextFloat()) * 0.4F);
        }
    }
