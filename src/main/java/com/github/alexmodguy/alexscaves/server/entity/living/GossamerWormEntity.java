...
public class GossamerWormEntity extends WaterAnimal implements Bucketable, ACMultipartOwner {
    ...
    protected float getStandingEyeHeight(Pose pose, EntityDimensions dimensions) {
        return 0.5F * ACCompat.height(dimensions);
    }
    ...
    public void tick() {
        ...
        this.tickMultipart();
        float targetPitch = ACCompat.isInWaterOrBubble(this) ? Mth.clamp((float) this.getDeltaMovement().y * 25, -1.4F, 1.4F) * -(float) (180F / (float) Math.PI) : 0;
        ...
        boolean grounded = !ACCompat.isInWaterOrBubble(this);
