...
public class RadioactiveOnDestroyedBlockItem extends RadioactiveBlockItem implements ACDestroyedItem {
    ...
    public void onDestroyed(ItemEntity itemEntity, DamageSource damageSource){
        ...
        if(!damageSource.isCreativePlayer() && !itemEntity.isRemoved()){
            ...
            ACCompat.setCloudColor(cloud, 0X77D60E);
            cloud.addEffect(new MobEffectInstance(ACCompat.effect(ACEffectRegistry.IRRADIATED.get()), 9600, 1));
