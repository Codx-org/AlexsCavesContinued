...
public class WatcherEntity extends Monster implements IAnimatedEntity, PossessesCamera {
    ...
    private static final EntityDataAccessor<Optional<UUID>> POSSESSED_ENTITY_UUID = SynchedEntityData.defineId(WatcherEntity.class, ACEntityDataRegistry.OPTIONAL_UUID.get());
    ...
    public boolean canPossessTargetEntity(Entity entity) {
        if (entity instanceof Player player) {
            ...
            if (data != null) {
                long timeElapsed = level().getGameTime() - ACCompat.getLong(data, LAST_POSSESSED_TIME_IDENTIFIER);
