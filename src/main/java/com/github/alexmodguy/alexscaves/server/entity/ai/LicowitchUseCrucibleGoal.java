...
public class LicowitchUseCrucibleGoal extends Goal {
    ...
    private static Stream<BlockPos> getNearbyCrucibles(BlockPos blockpos, ServerLevel world, int range) {
        ...
        return pointofinterestmanager.findAll(poiTypeHolder -> poiTypeHolder.is(ACPOIRegistry.CONVERSION_CRUCIBLE_KEY), blockpos2 -> canWitchUseCrucibleAt(world, blockpos2, true), blockpos, range, PoiManager.Occupancy.ANY);
    }
