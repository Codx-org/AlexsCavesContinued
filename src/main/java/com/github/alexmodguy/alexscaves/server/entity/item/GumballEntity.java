...
public class GumballEntity extends ThrowableProjectile {
    ...
    private int bounceSoundCooldown = 0;
        ...
        public GumballEntity(EntityType entityType, Level level) {
            ...
            this.setColor(level.getRandom().nextInt(12));
        }
    ...
    *///?} else {
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        if(splitsOnHit()){
            for(int i = 0; i < 3; i++){
                GumballEntity gumballEntity = ACCompat.createEntity(ACEntityRegistry.GUMBALL.get(), level());
    ...
    protected void readAdditionalSaveData(CompoundTag compoundTag) {
        ...
        this.setColor(ACCompat.getInt(compoundTag, "Color"));
    }
