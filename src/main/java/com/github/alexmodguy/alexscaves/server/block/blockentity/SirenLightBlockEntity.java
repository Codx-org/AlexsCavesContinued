...
public class SirenLightBlockEntity extends BlockEntity implements ACUpdatePacketReceiver {
    ...
    public void load(CompoundTag tag) {
        super.load(tag);
        this.color = ACCompat.getInt(tag, "Color");
    }
    ...
    public void onDataPacket(Connection net, ClientboundBlockEntityDataPacket packet) {
        if (packet != null && packet.getTag() != null) {
            this.color = ACCompat.getInt(packet.getTag(), "Color");
        }
    }
    ...
    public AABB getRenderBoundingBox() {
        ...
        return ACPlatform.encapsulating(pos.offset(-3, -3, -3), pos.offset(4, 4, 4));
    }
