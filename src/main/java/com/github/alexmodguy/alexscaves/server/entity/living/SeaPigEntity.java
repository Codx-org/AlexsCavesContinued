    ...
    *///?} else {
    ...
    private void digestItem() {
        if (!level().isClientSide()) {
            LootTable loottable = ACCompat.lootTable(level().getServer(), DIGESTION_LOOT_TABLE);
            ...
            items.forEach(stack -> ACCompat.spawnAtLocation(this, stack));
        }
    ...
    private class WanderGoal extends Goal {
        ...
        protected Vec3 getPosition() {
            ...
            if (ACCompat.isInWaterOrBubble(SeaPigEntity.this)) {
                if (water == null) {
                    return null;
                }
