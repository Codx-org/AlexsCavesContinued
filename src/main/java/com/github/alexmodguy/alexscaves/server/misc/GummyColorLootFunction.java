...
public class GummyColorLootFunction extends LootItemConditionalFunction {
    ...
    protected GummyColorLootFunction(java.util.List<LootItemCondition> lootItemConditions) {
        super(lootItemConditions);
    }
    *///?} elif >=1.20.2 {
    /*public static final com.mojang.serialization.Codec<GummyColorLootFunction> CODEC =
            com.mojang.serialization.codecs.RecordCodecBuilder.create(
                    instance -> commonFields(instance).apply(instance, GummyColorLootFunction::new));
    ...
    *///?} else {
    ...
    @Override
    // LootItemFunctionType became generic in the function it deserialises in 1.20.5, and 26 deleted it
    // outright — the registry holds the MapCodec, so the accessor is codec() returning that.
    //? if >=26 {
    /*public @NotNull com.mojang.serialization.MapCodec<? extends LootItemConditionalFunction> codec() {
    *///?} elif >=1.20.5 {
    ...
    *///?} else {
    ...
    // Superseded by CODEC above from 1.20.2 on — LootItemConditionalFunction.Serializer is gone.
    //? if <1.20.2 {
    public static class Serializer extends LootItemConditionalFunction.Serializer<GummyColorLootFunction> {
        ...
        @Override
        public @NotNull GummyColorLootFunction deserialize(@NotNull JsonObject object, @NotNull JsonDeserializationContext deserializationContext, @NotNull LootItemCondition[] conditionsIn) {
