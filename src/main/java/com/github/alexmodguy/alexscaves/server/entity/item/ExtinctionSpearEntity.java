...
public class ExtinctionSpearEntity extends AbstractArrow {
    ...
    public ExtinctionSpearEntity(EntityType entityType, Level level) {
        ...
        //? if >=1.20.3 && <1.21
        /*super(entityType, level, new ItemStack(ACItemRegistry.EXTINCTION_SPEAR.get()));*/
        //? if <1.20.3
        super(entityType, level);
    }
    ...
    public ExtinctionSpearEntity(Level level, LivingEntity shooter, ItemStack itemStack) {
        ...
        //? if >=1.20.3 && <1.21
        /*super(ACEntityRegistry.EXTINCTION_SPEAR.get(), shooter, level, itemStack.copy());*/
        //? if <1.20.3
    ...
    public ExtinctionSpearEntity(Level level, double x, double y, double z) {
        ...
        //? if >=1.20.3 && <1.21
        /*super(ACEntityRegistry.EXTINCTION_SPEAR.get(), x, y, z, level, new ItemStack(ACItemRegistry.EXTINCTION_SPEAR.get()));*/
        //? if <1.20.3
        ...
        if ((this.inGround || this.isNoPhysics()) && entity != null) {
            if (!this.isAcceptibleReturnOwner()) {
                if (!this.level().isClientSide() && this.pickup == AbstractArrow.Pickup.ALLOWED) {
                    ACCompat.spawnAtLocation(this, this.getPickupItem(), 0.1F);
                }
    ...
    protected void onHitEntity(EntityHitResult hitResult) {
        ...
        if (ACCompat.hurt(entity, damagesource, f)) {
            ...
            if(entity1 != null){
                ...
                dinosaurSpirit.setEnchantmentLevel(ACCompat.enchantLevel(spearItem, ACEnchantmentRegistry.PLUMMETING_FLIGHT));
