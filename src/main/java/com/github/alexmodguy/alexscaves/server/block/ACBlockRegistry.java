...
public class ACBlockRegistry {
    ...
    public static BlockBehaviour.Properties GALENA_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PURPLE).requiresCorrectToolForDrops().strength(3.5F, 10.0F).sound(SoundType.DEEPSLATE); }
    public static BlockBehaviour.Properties ENERGIZED_GALENA_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PURPLE).requiresCorrectToolForDrops().strength(3F, 10.0F).lightLevel(state -> 5).sound(SoundType.DEEPSLATE); }
    public static BlockBehaviour.Properties LIMESTONE_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_YELLOW).requiresCorrectToolForDrops().strength(1.2F, 4.5F).sound(SoundType.DRIPSTONE_BLOCK); }
    public static BlockBehaviour.Properties PEWEN_LOG_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(2.0F).sound(SoundType.CHERRY_WOOD).instrument(NoteBlockInstrument.BASS); }
    public static BlockBehaviour.Properties PEWEN_PLANKS_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(2.0F, 3.0F).sound(SoundType.CHERRY_WOOD).instrument(NoteBlockInstrument.BASS); }
    public static BlockBehaviour.Properties RADROCK_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GREEN).requiresCorrectToolForDrops().strength(4F, 11.0F).sound(ACSoundTypes.RADROCK); }
    public static BlockBehaviour.Properties CINDER_BLOCK_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GRAY).requiresCorrectToolForDrops().strength(5F, 20.0F).sound(ACSoundTypes.CINDER_BLOCK); }
    public static BlockBehaviour.Properties RADON_LAMP_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_WHITE).requiresCorrectToolForDrops().lightLevel(state -> 15).strength(2F, 11.0F).sound(SoundType.GLASS); }
    public static BlockBehaviour.Properties SMOOTH_BONE_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.SAND).requiresCorrectToolForDrops().strength(2.0F).sound(SoundType.BONE_BLOCK); }
    public static BlockBehaviour.Properties ABYSSMARINE_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLUE).requiresCorrectToolForDrops().strength(2.5F, 50.0F).sound(SoundType.DEEPSLATE); }
    public static BlockBehaviour.Properties GUANOSTONE_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_CYAN).requiresCorrectToolForDrops().strength(1.3F, 2.0F).sound(SoundType.BASALT); }
    public static BlockBehaviour.Properties COPROLITH_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_ORANGE).requiresCorrectToolForDrops().strength(1.75F, 4.0F).sound(SoundType.CALCITE); }
    public static BlockBehaviour.Properties POROUS_COPROLITH_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_ORANGE).requiresCorrectToolForDrops().strength(1.75F, 4.0F).sound(SoundType.CALCITE).noOcclusion(); }
    public static BlockBehaviour.Properties PEERING_COPROLITH_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_ORANGE).requiresCorrectToolForDrops().strength(1.75F, 4.0F).sound(ACSoundTypes.PEERING_COPROLITH).noOcclusion(); }
    public static BlockBehaviour.Properties THORNWOOD_LOG_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(2.0F).sound(SoundType.WOOD).instrument(NoteBlockInstrument.BASS); }
    public static BlockBehaviour.Properties THORNWOOD_PLANKS_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD).instrument(NoteBlockInstrument.BASS); }
    public static BlockBehaviour.Properties CHOCOLATE_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BROWN).strength(1.0F, 2.0F).sound(ACSoundTypes.DENSE_CANDY).instrument(NoteBlockInstrument.BASEDRUM); }
    public static BlockBehaviour.Properties COOKIE_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.5F, 1.5F).sound(ACSoundTypes.DENSE_CANDY).instrument(NoteBlockInstrument.BASEDRUM); }
    public static BlockBehaviour.Properties DOUGH_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.0F, 1.5F).sound(SoundType.WOOL).instrument(NoteBlockInstrument.BASS); }
    public static BlockBehaviour.Properties LICOROOT_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK).strength(1.0F, 1.5F).sound(SoundType.NETHER_WOOD).instrument(NoteBlockInstrument.SNARE); }
    public static BlockBehaviour.Properties ROCK_CANDY_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_WHITE).strength(1.0F, 1.5F).sound(SoundType.STONE).instrument(NoteBlockInstrument.BASS); }
    public static BlockBehaviour.Properties GINGERBREAD_PROPERTIES() { return BlockBehaviour.Properties.of().mapColor(MapColor.DIRT).strength(1.0F, 1.5F).sound(ACSoundTypes.DENSE_CANDY).instrument(NoteBlockInstrument.BASS); }
