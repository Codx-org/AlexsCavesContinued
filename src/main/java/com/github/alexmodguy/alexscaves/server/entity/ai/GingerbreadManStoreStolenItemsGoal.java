...
public class GingerbreadManStoreStolenItemsGoal extends Goal {
    ...
    private Stream<BlockPos> getNearbyBarrels(BlockPos blockpos, ServerLevel world, int range) {
        ...
        return pointofinterestmanager.findAll(poiTypeHolder -> poiTypeHolder.is(ACPOIRegistry.GINGERBARREL_KEY), blockpos2 -> doesBarrelHaveSpace(world, blockpos2, mob.getItemInHand(InteractionHand.OFF_HAND)), blockpos, range, PoiManager.Occupancy.ANY);
    }
