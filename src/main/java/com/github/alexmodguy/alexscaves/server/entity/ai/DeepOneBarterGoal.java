...
public class DeepOneBarterGoal extends Goal {
    ...
    private static Stream<BlockPos> getNearbyAltars(BlockPos blockpos, ServerLevel world, int range) {
        ...
        return pointofinterestmanager.findAll(poiTypeHolder -> poiTypeHolder.is(ACPOIRegistry.ABYSSAL_ALTAR_KEY), blockpos2 -> hasPearls(world, blockpos2, true), blockpos, range, PoiManager.Occupancy.ANY);
    }
