...
public class UpdateItemTagMessage {
    ...
    public static void handle(UpdateItemTagMessage message, ACNetworkContext context) {
        ...
        if(playerSided != null){
            ...
            if (holder instanceof LivingEntity living) {
                ...
                if(to != null && to.getItem() instanceof UpdatesStackTags updatesStackTags && ACCompat.getTag(stackFrom) != null){
                    updatesStackTags.updateTagFromServer(holder, to, ACCompat.getTag(stackFrom));
                }
            }
        }
    }
