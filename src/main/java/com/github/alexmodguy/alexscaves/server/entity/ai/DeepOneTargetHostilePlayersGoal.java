...
public class DeepOneTargetHostilePlayersGoal extends NearestAttackableTargetGoal {
    ...
    protected void findTarget() {
        this.target = ACCompat.getNearestEntity(this.mob.level(), this.mob.level().getEntitiesOfClass(this.targetType, this.getTargetSearchArea(this.getFollowDistance()), (targetEntity) -> {
