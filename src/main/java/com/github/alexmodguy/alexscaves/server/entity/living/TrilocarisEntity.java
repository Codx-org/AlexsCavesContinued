...
public class TrilocarisEntity extends WaterAnimal implements Bucketable {
    ...
    public void tick() {
        ...
        if (!level().isClientSide()) {
            ...
            if (crawling || !ACCompat.isInWaterOrBubble(this)) {
                timeSwimming = 0;
                if(delta > 0.01F){
    ...
    private class WanderGoal extends Goal {
        ...
        protected Vec3 getPosition() {
            ...
            if (ACCompat.isInWaterOrBubble(TrilocarisEntity.this)) {
                if (water == null) {
                    return null;
                }
                if (this.isCrawling) {
