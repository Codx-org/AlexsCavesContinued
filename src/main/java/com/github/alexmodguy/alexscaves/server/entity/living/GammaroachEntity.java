...
public class GammaroachEntity extends PathfinderMob implements IAnimatedEntity {
    ...
    private static final Predicate<LivingEntity> IRRADIATED_TARGET = (mob) -> {
        return mob.hasEffect(ACCompat.effect(ACEffectRegistry.IRRADIATED.get())) && !(mob instanceof RaycatEntity);
    };
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 20, false, true, ACCompat.targetSelector(IRRADIATED_TARGET)));
    }
    ...
    public boolean canBeAffected(MobEffectInstance effectInstance) {
        return super.canBeAffected(effectInstance) && ACCompat.vanillaEffect(effectInstance.getEffect()) != ACEffectRegistry.IRRADIATED.get();
    }
    ...
    public void tick() {
        ...
        if (this.getAnimation() == ANIMATION_SPRAY) {
            if (this.getAnimationTick() == 10) {
                ...
                areaeffectcloud.addEffect(new MobEffectInstance(ACCompat.effect(ACEffectRegistry.IRRADIATED.get()), 2000));
    ...
    public boolean hurt(DamageSource damageSource, float damageAmount) {
        ...
        if (prev && hurter instanceof LivingEntity living && !living.hasEffect(ACCompat.effect(ACEffectRegistry.IRRADIATED.get()))) {
            triggerSpraying();
        }
        return prev;
    }
    ...
    public void readAdditionalSaveData(CompoundTag compound) {
        ...
        this.setSprayCooldown(ACCompat.getInt(compound, "SprayCooldown"));
    }
