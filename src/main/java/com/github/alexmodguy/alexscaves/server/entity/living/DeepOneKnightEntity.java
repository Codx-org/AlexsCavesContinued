...
public class DeepOneKnightEntity extends DeepOneBaseEntity {
    ...
    private static final EntityDimensions SWIMMING_SIZE = ACCompat.dimensions(1.2F, 1.3F, false);
    ...
    public void addAdditionalSaveData(CompoundTag compound) {
        ...
        if (this.lastThrownTrident != null) {
            ACCompat.putUUID(compound, "LastTridentUUID", this.lastThrownTrident);
        }
    }

    public void readAdditionalSaveData(CompoundTag compound) {
        super.readAdditionalSaveData(compound);
        if (ACCompat.hasUUID(compound, "LastTridentUUID")) {
            this.lastThrownTrident = ACCompat.getUUID(compound, "LastTridentUUID");
        }
    }
