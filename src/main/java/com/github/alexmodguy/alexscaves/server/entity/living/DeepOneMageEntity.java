...
public class DeepOneMageEntity extends DeepOneBaseEntity {
    ...
    private static final EntityDimensions SWIMMING_SIZE = ACCompat.dimensions(1.2F, 1.5F, false);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(5, new RandomStrollGoal(this, 1.0D, 45) {
            ...
            public boolean canUse() {
                return !ACCompat.isInWaterOrBubble(DeepOneMageEntity.this) && super.canUse() && DeepOneMageEntity.this.getAnimation() != DeepOneMageEntity.ANIMATION_TRADE;
            }

            @Override
            public boolean canContinueToUse() {
                return !ACCompat.isInWaterOrBubble(DeepOneMageEntity.this) && DeepOneMageEntity.this.getAnimation() != DeepOneMageEntity.ANIMATION_TRADE && super.canContinueToUse();
            }
    ...
    public void tick() {
        super.tick();
        if (!ACCompat.isInWaterOrBubble(this) && !this.hasEffect(ACCompat.effect(ACEffectRegistry.BUBBLED.get()))) {
            this.addEffect(new MobEffectInstance(ACCompat.effect(ACEffectRegistry.BUBBLED.get()), 200));
        }
        if (ACCompat.isInWaterOrBubble(this) && this.hasEffect(ACCompat.effect(ACEffectRegistry.BUBBLED.get()))) {
            this.removeEffect(ACCompat.effect(ACEffectRegistry.BUBBLED.get()));
        }
        isMageInWater = ACCompat.isInWaterOrBubble(this);
