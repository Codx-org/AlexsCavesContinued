...
public class UpdateEffectVisualityEntityMessage {
    ...
    public static void handle(UpdateEffectVisualityEntityMessage message, ACNetworkContext context) {
        ...
        if (playerSided != null) {
            ...
            if (entity instanceof LivingEntity living && senderEntity != null && senderEntity.distanceTo(living) < 32) {
                ...
                if (mobEffect != null) {
                    if (message.remove) {
                        living.removeEffectNoUpdate(ACCompat.effect(mobEffect));
                    } else {
                        living.addEffect(new MobEffectInstance(ACCompat.effect(mobEffect), message.duration, level));
                    }
                }
            }
        }
