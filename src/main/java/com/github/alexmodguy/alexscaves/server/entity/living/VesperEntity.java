...
public class VesperEntity extends Monster implements IAnimatedEntity, UnderzealotSacrifice, CullingBoundsEntity {
    ...
    public void tick() {
        ...
        if (isBeingSacrificed && this.isPassenger() && !level().isClientSide()) {
            ...
            if (sacrificeTime < 0) {
                ...
                this.stopRiding();
                ForsakenEntity forsakenEntity = ACCompat.convertTo(this, ACEntityRegistry.FORSAKEN.get(), true);
