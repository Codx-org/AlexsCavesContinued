...
public class AllFluidsNodeEvaluator extends SwimNodeEvaluator {
    ...
    // 1.20.5 renamed the per-cell hook and folded the level it reads into the PathfindingContext.
    // Only the header differs; the body below works off `getter` either way.
    //? if >=1.20.5 {
    /*@Override
    public BlockPathTypes getPathTypeOfMob(net.minecraft.world.level.pathfinder.PathfindingContext context, int x, int y, int z, Mob mob) {
